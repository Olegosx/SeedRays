...
|------------|-------------|----------|
| `SEEDRAYS_DATA_DIR` | да | Каталог данных: реестровая база, базы пользователей, `logs/security.log`. |
...
Что копировать: весь каталог данных — реестровую базу, базы пользователей и, по
